 ...
 * This file demonstrates how to integrate Orbityarn with a web frontend
 */

// For React/Vue/Angular applications
export class OrbityarnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new OrbityarnClient(provider, contractAddress);
